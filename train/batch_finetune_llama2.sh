...
#SBATCH --job-name=gradsim_hf_llama2
...
# sbatch train/batch_finetune_llama2.sh --method bm25_llama2
# sbatch train/batch_finetune_llama2.sh --method gradsim_hf_llama2
set -ex
...
out_dir="/data/group_data/cx_group/date-models/Llama-2-7b-hf-tulu2-${METHOD}-${TASK}/"
